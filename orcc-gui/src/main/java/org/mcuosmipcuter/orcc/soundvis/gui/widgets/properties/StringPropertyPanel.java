...
public class StringPropertyPanel extends PropertyPanel<String> {
	 ...
	 */
	public StringPropertyPanel(SoundCanvasWrapper soundCanvasWrapper, Object valueOwner, final JFrame frame) {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int res = JOptionPane.showConfirmDialog(frame, array, "set value for string property", 
